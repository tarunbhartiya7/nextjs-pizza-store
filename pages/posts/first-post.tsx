...
import test_image from "../../public/images/test_image.png";

interface LayoutProps {
  children: React.ReactNode;
}

const Code = ({ children }: LayoutProps) => (
  <code className={styles.inlineCode} {...children} />
);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <Image alt="test image" src={test_image} width={1000} height={1000} />
        <hr className={styles.hr} />
        ...
        <Image
          alt="profile"
          src="https://res.cloudinary.com/dexkvngbv/image/upload/v1627920277/dubai_aqua_park_vamb1o.jpg"
          width={400}
          height={400}
        />
        <hr className={styles.hr} />
